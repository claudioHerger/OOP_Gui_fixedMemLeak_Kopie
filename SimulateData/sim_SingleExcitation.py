...
if __name__ == "__main__":
    # start = time.time()
    # test_ta_sim_obj = SingleExcitation(os.getcwd()+"/configFiles/test_config_file.ini", make_plots=True)
    ...
    for file in os.listdir(os.getcwd()+"/configFiles/"):
        if file == "overlap_wavelength0.ini":
            ...
            print(f'file: {file}')
            start = time.time()
            multi_excitation_obj = SingleExcitation(os.getcwd()+"/configFiles/"+file, make_plots=True)
